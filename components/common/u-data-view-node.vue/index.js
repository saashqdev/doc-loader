    ...
    methods: {
        ...
        edit() {
            ...
            this.editingValue = JSON.stringify(this.currentValue, (key, value) => {
                if (value === undefined)
                    return '__kubevue__undefined__';
                else if (typeof value === 'number' && isNaN(value))
                    return '__kubevue__NaN__';
                else if (value === Infinity)
                    return '__kubevue__Infinity__';
                return value;
            })
                .replace(/"__kubevue__undefined__"/g, 'undefined')
                .replace(/"__kubevue__NaN__"/g, 'NaN')
                .replace(/"__kubevue__Infinity__"/g, 'Infinity');
